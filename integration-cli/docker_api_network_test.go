...
func (s *DockerSuite) TestApiNetworkInspect(c *check.C) {
	...
	config := types.NetworkCreate{
		...
		Driver:     "bridge",
		IpamDriver: "default",
		Ipam:       []network.IpamData{{Subnet: "172.28.0.0/16", IPRange: "172.28.5.0/24", Gateway: "172.28.5.254"}},
	}
...
func (s *DockerSuite) TestApiNetworkIpamMultipleBridgeNetworks(c *check.C) {
	...
	config0 := types.NetworkCreate{
		...
		Driver:     "bridge",
		IpamDriver: "default",
		Ipam:       []network.IpamData{{Subnet: "192.178.0.0/16", IPRange: "192.178.128.0/17", Gateway: "192.178.138.100"}},
	}
	...
	config1 := types.NetworkCreate{
		...
		Driver:     "bridge",
		IpamDriver: "default",
		Ipam:       []network.IpamData{{Subnet: "192.178.128.0/17", Gateway: "192.178.128.1"}},
	}
	...
	config2 := types.NetworkCreate{
		...
		Driver:     "bridge",
		IpamDriver: "default",
		Ipam:       []network.IpamData{{Subnet: "192.169.0.0/16", Gateway: "192.169.100.100"}},
	}
